...
describe('~/fb-client/user/jwt/client', () => {
  describe('Always', () => {
    ...
    describe('Instantiating a client', () => {
      ...
      describe('Without a service secret parameter', () => {
        it('throws an error', () => expect(() => new Client()).to.throw(Error, 'No service secret passed to client'))
  ...
  describe('Generating a JSON web token with `encodedPrivateKey`', () => {
    let client
    let clock
    let accessToken

    describe('`encodedPrivateKey` is a string', () => {
      beforeEach(() => {
        client = new Client(serviceSecret, serviceSlug, microserviceUrl, undefined, encodedPrivateKey)
    ...
    describe('`encodedPrivateKey` is a field of an object', () => {
      const options = {
    ...
    describe('POST requests', () => {
      describe('With data', () => {
        ...
        describe('With private key available', () => {
          describe('The private key is a string', () => {
            it('defines x-access-token-v2', () => {
              const client = new Client(serviceSecret, serviceSlug, microserviceUrl, undefined, encodedPrivateKey)
          ...
          describe('The private key is a field on an object', () => {
            it('defines x-access-token-v2', () => {
        ...
        it('calls `logger.error()', () => {
          expect(errorStub)
            .to.be.calledWith({
              ...
              method: 'get',
              error
            }, 'JWT API request error: Client: GET https://microservice/url - Error - mock error code - 400 - mock status message - {"name":"mock error name","message":"mock error message","code":400}')
        })
      })
        ...
        it('calls `logger.error()', () => {
          expect(errorStub)
            .to.be.calledWith({
              ...
              method: 'get',
              error
            }, 'JWT API request error: Client: GET https://microservice/url - Error -  -  -  - ')
        })
      })
    })
        ...
        it('calls `logger.error()', () => {
          expect(errorStub)
            .to.be.calledWith({
              ...
              method: 'post',
              error
            }, 'JWT API request error: Client: POST https://microservice/url - Error - mock error code - 400 - mock status message - {"name":"mock error name","message":"mock error message","code":400}')
        })
      })
        ...
        it('calls `logger.error()', () => {
          expect(errorStub)
            .to.be.calledWith({
              ...
              method: 'post',
              error
            }, 'JWT API request error: Client: POST https://microservice/url - Error -  -  -  - ')
        })
      })
    })
  })
